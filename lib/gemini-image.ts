...
【重要ルール】
- 素材画像の下にIDやラベル名（"appstore"、"logo"、"playstore"等）を絶対に書かないこと。キャプションやラベルは不要。
- アプリのスクリーンショットはUIの枠組み・レイアウトは維持しつつ、中のユーザー写真やテキスト内容は自由に変えてよい（架空のカップル写真やメッセージに差し替えてOK）。
- 公式キャラクターは見た目の特徴（デザイン・色合い）を維持しつつ、ポーズや表情は自由にアレンジしてよい。
